...
Crebs
<pre><code>sudo add-apt-repository ppa:crebs/ppa
sudo aptitude update && sudo aptitude install crebs</code></pre>

Synapse
<pre><code>sudo add-apt-repository ppa:synapse-core/ppa
sudo aptitude update && sudo aptitude install synapse</code></pre>

Guake
<pre><code>sudo aptitude install guake</code></pre>
...
<pre><code>cp -R ~/.setuplinux/files/docky/themes ~/.local/share/docky</code></pre>
