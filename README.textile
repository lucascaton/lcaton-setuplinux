post. Personalização das configurações após instalação do Ubuntu Linux

post. *Versão atual:* Ubuntu 10.04 (desktop edition)
...
<pre><code>cp ~/.setuplinux/dotfiles/.bashrc ~</code></pre>
<pre><code>cp ~/.setuplinux/dotfiles/.fonts.conf ~</code></pre>
<pre><code>cp ~/.setuplinux/dotfiles/.gemrs ~</code></pre>
<pre><code>cp ~/.setuplinux/dotfiles/.gitconfig ~</code></pre>
<pre><code>cp ~/.setuplinux/dotfiles/.irbrc ~</code></pre>
